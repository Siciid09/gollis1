    ...
    <div className="bg-[#030303] min-h-screen text-neutral-200 font-sans selection:bg-amber-500/30 selection:text-amber-200 overflow-hidden">
      ...
      <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${isScrolled ? "bg-black/60 backdrop-blur-2xl border-b border-white/5 py-3" : "bg-transparent py-6"}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-neutral-400">
            {["Heritage", "Services", "Process", "Collection", "Contact"].map((item) => (
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden z-10">
        <motion.div style={{ scale }} className="absolute inset-0 z-0">
          ...
          <img src="https://images.unsplash.com/photo-1593030761757-71fae46af504?auto=format&fit=crop&q=80" alt="Bespoke Suit" className="w-full h-full object-cover object-top opacity-50 grayscale mix-blend-overlay" />
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 flex flex-col items-center text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} className="text-6xl md:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-6">
            CRAFTED FOR <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-500 to-amber-700">LEGACY.</span>
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.4 }} className="max-w-xl text-neutral-400 text-lg md:text-xl font-medium mb-10">
            Precision engineering meets sartorial elegance. We design bespoke garments that command respect and define your personal narrative.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.6 }} className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <Link href="#collection" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white text-black font-black text-sm uppercase tracking-wide hover:bg-neutral-200 transition-colors shadow-[0_0_40px_rgba(255,255,255,0.2)]">
              View Collection
            </Link>
            <Link href="/auth" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-amber-600/10 border border-amber-500/30 text-amber-500 font-black text-sm uppercase tracking-wide hover:bg-amber-500/20 transition-all flex items-center justify-center gap-2">
              <ShieldCheck size={18} /> Client Portal
            </Link>
          </motion.div>
        </div>
      ...
      <section id="heritage" className="py-32 relative z-10 border-t border-white/5 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="space-y-6">
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">A DECADE OF <br/><span className="text-amber-500">EXCELLENCE.</span></h2>
            <p className="text-neutral-400 text-lg leading-relaxed">
              Founded on the principles of immaculate precision and uncompromising quality, Yoonis Tailor has redefined bespoke menswear. Every stitch is a testament to our dedication to the craft, merging traditional Savile Row techniques with modern architectural silhouettes.
            </p>
            <div className="flex items-center gap-8 pt-4">
              <div>
                <p className="text-3xl font-black text-white">10+</p>
                <p className="text-xs text-amber-500 uppercase tracking-wider font-bold">Years Heritage</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10" />
              <div>
                <p className="text-3xl font-black text-white">5K+</p>
                <p className="text-xs text-amber-500 uppercase tracking-wider font-bold">Garments Crafted</p>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className="relative aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden border border-white/10 group">
            ...
            <img src="https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&q=80" alt="Tailor at work" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000 ease-out" />
            <div className="absolute bottom-8 left-8 z-20 flex items-center gap-4">
              ...
              <span className="text-sm font-bold text-white uppercase tracking-widest">Watch Our Story</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="services" className="py-32 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Bespoke Suiting", icon: Scissors, desc: "Created entirely from scratch based on your unique anatomy and style preferences." },
              { title: "Made to Measure", icon: Ruler, desc: "Pre-designed silhouettes precision-altered to map perfectly to your body." },
              { title: "Refined Alterations", icon: Crosshair, desc: "Surgical reconstruction of existing garments to achieve the perfect drape." }
            ].map((srv, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="text-4xl font-black text-white uppercase tracking-tight mb-6">The Anatomy of <br/><span className="text-amber-500">Creation</span></h2>
              <p className="text-neutral-400 mb-12">From the initial drape to the final buttonhole, our multi-stage process ensures a garment that functions as a second skin.</p>
              
              <div className="space-y-8">
                {[
                  { step: "01", title: "Consultation & Ideation", desc: "Selecting fabrics, discussing lifestyle requirements, and drafting the initial silhouette." },
                  { step: "02", title: "Anatomical Mapping", desc: "Taking over 30 precise body measurements to create your unique physical blueprint." },
                  { step: "03", title: "Basted Fitting", desc: "A skeleton garment is tested on your body to refine the drape, balance, and proportions." },
                  { step: "04", title: "Final Commission", desc: "The finished armor is delivered, ensuring every millimeter aligns with perfection." }
                ].map((item, i) => (
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 h-full min-h-[500px]">
              <img src="https://images.unsplash.com/photo-1578932750294-f5075e85f44a?auto=format&fit=crop&q=80" alt="Process Blueprint" className="w-full h-full object-cover grayscale opacity-60" />
      ...
      <section id="collection" className="py-32 relative z-10">
        <div className="max-w-[1400px] mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex justify-between items-end mb-16">
            <div>
              <h2 className="text-4xl font-black text-white uppercase tracking-tight">The <span className="text-amber-500">Lookbook</span></h2>
              <p className="text-neutral-500 mt-2">A curated selection of our finest commissions.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="group relative aspect-[3/4] overflow-hidden rounded-2xl cursor-pointer">
                ...
                <img src={img} alt={`Lookbook ${i}`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute bottom-0 inset-x-0 p-6 bg-gradient-to-t from-black via-black/60 to-transparent z-20 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all">
                  <p className="text-white font-black text-lg">Bespoke Commission #{104 + i}</p>
                  <p className="text-amber-500 text-xs font-bold uppercase tracking-widest">Italian Wool</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {['VBC 1663', 'Loro Piana', 'Holland & Sherry', 'Zegna'].map((mill, i) => (
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { num: "30+", label: "Measurements" },
              { num: "50h", label: "Handwork per Suit" },
              { num: "100%", label: "Bespoke Guarantee" },
              { num: "15+", label: "Master Artisans" }
            ].map((stat, i) => (
      ...
      <section className="py-32 bg-[#050505] relative z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-3xl font-black text-white uppercase tracking-tight mb-16">Echoes of <span className="text-amber-500">Perfection</span></motion.h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "James Caldwell", role: "CEO, Capital Partners", text: "The fit is unparalleled. It doesn't just look like success; it feels like armor. Yoonis has ruined off-the-rack clothing for me forever." },
              { name: "Marcus Thorne", role: "Creative Director", text: "Their understanding of modern silhouette mixed with traditional canvas construction is brilliant. Pure artistry in motion." },
              { name: "David Lin", role: "Attorney at Law", text: "The meticulous attention to my posture and shoulder drop during the basted fitting resulted in the most comfortable suit I've ever owned." }
            ].map((t, i) => (
      ...
      <section className="py-32 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-white uppercase tracking-tight">The <span className="text-amber-500">Master Craftsmen</span></h2>
            <p className="text-neutral-500 mt-2">The hands behind the legacy.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { name: "Hassan Yoonis", role: "Head Cutter & Founder", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80" },
              { name: "Elias Vance", role: "Master Tailor", img: "https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?auto=format&fit=crop&q=80" }
            ].map((master, i) => (
      ...
      <section className="py-32 bg-[#050505] relative z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-white uppercase tracking-tight">Commission <span className="text-amber-500">Tiers</span></h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* MTM Tier */}
            <div className="bg-white/[0.02] border border-white/5 p-10 rounded-3xl">
              <h3 className="text-xl font-black text-white uppercase tracking-wider mb-2">Made to Measure</h3>
              <p className="text-neutral-400 text-sm mb-6">Pre-designed blocks tailored to your measurements.</p>
              <div className="text-3xl font-black text-white mb-8">From $1,200</div>
              <ul className="space-y-4 mb-10 text-sm text-neutral-300">
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> 15+ Core Measurements</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> Half-Canvas Construction</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> 4-6 Weeks Delivery</li>
              </ul>
              <button className="w-full py-4 rounded-xl border border-white/10 text-white font-bold hover:bg-white/5 transition-colors">Inquire Now</button>
            </div>
            ...
            <div className="bg-gradient-to-b from-amber-900/20 to-black border border-amber-500/30 p-10 rounded-3xl relative overflow-hidden shadow-[0_0_50px_rgba(217,119,6,0.1)]">
              <div className="absolute top-0 right-0 bg-amber-500 text-black text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-bl-xl">Signature</div>
              <h3 className="text-xl font-black text-white uppercase tracking-wider mb-2">True Bespoke</h3>
              <p className="text-neutral-400 text-sm mb-6">A unique pattern drafted exclusively for your body.</p>
              <div className="text-3xl font-black text-amber-500 mb-8">From $2,800</div>
              <ul className="space-y-4 mb-10 text-sm text-neutral-300">
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> 30+ Point Anatomy Mapping</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> Full-Canvas Hand Stitched</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> 2-3 Basted Fittings</li>
                <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-amber-500" /> Infinite Fabric Selection</li>
              </ul>
              <button className="w-full py-4 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-bold shadow-lg shadow-amber-600/20 transition-all">Book Consultation</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 relative z-10">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-white uppercase tracking-tight">Client <span className="text-amber-500">Inquiries</span></h2>
          </div>
          <div className="space-y-4">
            {[
              { q: "How long does a bespoke commission take?", a: "A first-time bespoke commission typically requires 8-10 weeks, accounting for drafting your unique pattern and multiple basted fittings. Subsequent orders generally take 6-8 weeks." },
              { q: "Do I need to schedule an appointment?", a: "Yes, we operate strictly by appointment to ensure every client receives the undivided attention of our master tailors during the consultation and measurement phases." },
              { q: "Can you replicate a suit I already own?", a: "We can use an existing garment as a reference for styling preferences, but we will draft a new pattern based on our proprietary measurement techniques to ensure a superior fit." }
            ].map((faq, i) => (
      ...
      <footer id="contact" className="relative z-10 border-t border-white/10 bg-black pt-32 pb-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 mb-24">
            <div>
              <h2 className="text-5xl font-black text-white uppercase tracking-tight mb-6">Begin Your <br/><span className="text-amber-500">Legacy.</span></h2>
              <p className="text-neutral-400 max-w-md mb-8">Secure your appointment for a private consultation and experience tailoring without compromise.</p>
            ...
            <div className="grid grid-cols-2 gap-8 text-sm">
              <div className="space-y-4">
                <h4 className="text-white font-bold uppercase tracking-widest mb-4">Atelier</h4>
                <p className="text-neutral-400 flex items-start gap-2"><MapPin size={16} className="text-amber-500 shrink-0 mt-0.5" /> 124 Sartorial Ave, Hargeisa, Somalia</p>
                <p className="text-neutral-400 flex items-center gap-2"><Clock size={16} className="text-amber-500" /> Mon - Sat, 9AM - 6PM</p>
              </div>
              <div className="space-y-4">
